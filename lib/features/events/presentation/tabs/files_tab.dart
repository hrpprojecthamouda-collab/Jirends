...
class FilesTab extends ConsumerWidget {
  const FilesTab({super.key, required this.eventId});
  ...
  Future<void> _pickAndUpload(BuildContext context, WidgetRef ref) async {
    ...
    await ref.read(attachmentActionsControllerProvider.notifier).upload(
          eventId,
...
class _FileTile extends ConsumerWidget {
  const _FileTile({required this.eventId, required this.file});
  final String eventId;
